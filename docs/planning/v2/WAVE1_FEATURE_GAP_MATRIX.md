...
| G024 | Org Browser | Complete metadata-family coverage with explicit and reliable tree expansion from both browse and search surfaces | Operators must browse by familiar family and expand child items without hidden gestures or ambiguous coverage state | Wave11 | Browser lists full discovered families, clearly signals limited fallback coverage, and every family row expands/collapses with deterministic child loading | In Progress |
