...
- semantic-frame v1 is authoritative only for the impact family; broader Ask families still rely on the legacy planner path
...
- expand semantic-frame gating from impact into the next bounded Ask family after parity holds
