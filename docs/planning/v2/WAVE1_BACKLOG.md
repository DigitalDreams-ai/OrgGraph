...
| B026 | P1 | Browser | Remove fixed family ceiling and make family row expansion explicit/reliable in Org Browser | Wave11 | Browser lists full live metadata family catalog and every family row supports deterministic expand/load of nested items | Complete |
