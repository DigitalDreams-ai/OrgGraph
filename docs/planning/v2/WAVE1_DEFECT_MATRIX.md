...
|---|---|---|---|---|---|---|---|
| D001 | S1 | Packaged Runtime | App can fail at startup with semantic drift budget exception in local operator flow | Bootstrap fixture/graph state mismatch and strict drift threshold handling at startup | Wave2 | `pnpm desktop:smoke:release` + manual packaged launch | Open |
