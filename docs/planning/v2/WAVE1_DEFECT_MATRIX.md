...
| D016 | S1 | Org Browser | Browse-by-family can omit metadata families and family rows can be non-expandable in operator flow | Fixed-size live catalog seeding plus weak expand affordance/reliability in family rows | Wave11 | Real-org browser pass shows full family catalog + deterministic expand/load behavior for nested items | In Progress |
