# Orgumented Phase 25 Task List (LLM Rollout Governance + Ops Hardening)

Goal: operationalize LLM support with controlled rollout, measurable quality deltas, and production-grade governance after WebUI-first runtime is stable.
...
## Deliverables
- [ ] Implement shadow mode toggle (compute LLM path, do not serve by default)
