...
const REQUIRED_FIELDS = [
  ...
  ['Smoke Evidence', 'GitHub artifact workflow key'],
  ['Smoke Evidence', 'GitHub artifact run URL'],
  ['Smoke Evidence', 'GitHub artifact name'],
  ['Smoke Evidence', 'GitHub artifact download URL'],
  ...
  ['Rollback Target', 'Last known-good GitHub artifact URL'],
